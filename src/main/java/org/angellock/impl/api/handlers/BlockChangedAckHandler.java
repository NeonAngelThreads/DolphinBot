...
public class BlockChangedAckHandler extends AbstractEventProcessor<ClientboundBlockChangedAckPacket> {
    @Override
    protected boolean isTargetPacket(Packet packet) {
        return (packet instanceof ClientboundBlockChangedAckPacket);
    }
}
